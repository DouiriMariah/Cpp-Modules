...
PmergeMe::PmergeMe(std::vector<int> sequence) /*: elements(final)*/
{
        ...
        // std::deque<int>::iterator it = stock2.begin();
//         while(it != stock2.end())
//     {
//         // second.insert(it, *it);
//         std::cout << "Stock2 = " << *it << " ";
...
//         {
//                 std::cout << "Stock1 = " <<stock1[i] << " ";
//         }
}

std::vector<int> PmergeMe::getVector()const {return stock1;}
std::deque<int> PmergeMe::getDeque()const {return stock2;}

double PmergeMe::GetVectorTime() const {return(vector_time);}
double PmergeMe::GetDequeTime() const {return(deque_time);}



PmergeMe::PmergeMe(PmergeMe const &copy){(void)copy;}

PmergeMe& PmergeMe::operator=(PmergeMe const &src){(void)src; return(*this);}
